...
export const metadata = {
  title: 'Order Confirmation | Seodrra - Your Order Has Been Successfully Placed',
  description:
    'Congratulations! Your order has been successfully placed on Seodrra. Thank you for choosing us for your shopping needs. Expect fast processing and delivery. Stay tuned for updates on your order status. Shop more with Seodrra!',
  applicationName: 'Seodrra',
  authors: 'Seodrra',
  keywords:
    'order confirmation, Seodrra, order placed, successful order, order processing, order delivery, order status, order updates, fast delivery, shopping confirmation, shopping success, shopping updates, online shopping'
};
