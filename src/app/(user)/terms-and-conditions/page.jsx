    ...
    <>
      ...
      <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
        ...
        <Typography variant="body1" paragraph>
          Welcome to Seodrra! These terms and conditions outline the rules and regulations for the use of Seodrra's
          Website.
        </Typography>
        <Typography variant="body1" paragraph>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use Seodrra if
        ...
        <Typography variant="body1" paragraph>
          Unless otherwise stated, Seodrra and/or its licensors own the intellectual property rights for all material on
          Seodrra. All intellectual property rights are reserved. You may access this from Seodrra for your own personal
        ...
        <Typography variant="body1" paragraph>
          ...
          certain areas of the website. Seodrra does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and opinions of Seodrra, its agents, and/or
