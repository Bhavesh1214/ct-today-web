...
export const productsByGifting = async (slug) => {
  const { data: response } = await http.get(`/products/by/gifting/${slug}`);
  return response;
};
...
export const offereProducts = async () => {
  const { data } = await http.get(`/discount/products`);
  return data;
};
export const getGifting = async () => {
  const { data } = await http.get(`/banner`);
  return data;
};
...
export const getAllCms = async () => {
  const { data } = await http.get(`/cms`);
  return data;
};

export const getAllCmsByAdmin = async () => {
  const { data } = await http.get(`/admin/all-cms`);
  return data;
};
