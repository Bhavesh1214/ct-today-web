      ...
      >
        {isLoading ? (
          ...
          >
            <Image
              alt="shop"
              src={process.env.IMAGE_BASE == 'LOCAL' ? `${process.env.IMAGE_URL}${shop?.cover?.url}` : shop?.cover?.url}
              placeholder="blur"
            ...
            >
              ...
              >
                <Image
                  alt="shop"
                  src={
                    process.env.IMAGE_BASE == 'LOCAL' ? `${process.env.IMAGE_URL}${shop?.logo?.url}` : shop?.logo?.url
                  }
                  placeholder="blur"
