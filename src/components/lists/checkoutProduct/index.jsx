  ...
  return (
    <RootStyled>
      <Table>
        ...
        <TableBody>
          {cart.map((product) => {
            const { sku, name, color, quantity, available, price, priceSale, image } = product;
                    ...
                    {isLoading ? (
                      ...
                      <ThumbImgStyle>
                        <BlurImage
                          ...
                          fill
                          alt="product image"
                          src={process.env.IMAGE_BASE == 'LOCAL' ? `${process.env.IMAGE_URL}${image}` : image}
                        />
                      </ThumbImgStyle>
                    )}
                    <Box>
