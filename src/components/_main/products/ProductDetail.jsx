...
export default function ProductCardDetail({ response, slug }) {
  ...
  const { data, totalRating, totalReviews, brand, metadata, category } = response;
      ...
      <Stack gap={5} paddingTop={4}>
        <Grid container spacing={2} justifyContent="center">
          <Grid item xs={12} sm={6} md={4} lg={4}>
            <ProductDetailsCarousel slug={slug} product={data} data={data} productColorIndex={productColorIndex} />
          </Grid>
